						...
						<div class="row">
							<div class="col-md-6">
								...
								<form method="post" enctype="multipart/form-data">
									<?php 
										echo "<img src='img/admin.png' class='col-md-12' style='width: 250px;'>";
									?> 
								...
								<form method="post">
									...
									<input type="submit" name="change" class="btn btn-success mt-2">
								</form>
							</div>
							<div class="col-md-6">
								...
								<form method="post"> 
									...
									<input type="submit" name="update_pass" value="Update Password" class="btn btn-info mt-2">
								</form>
							</div>
						</div>
					</div>
