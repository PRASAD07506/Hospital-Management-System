	...
	<div class="container" style="margin-top: 20px;"> 
		<div class="col-md-12"> 
			<div class="d-flex flex-row justify-content-center"> 
				<div class="col-md-6 mt-4 p-5 bg-light rounded"> <!--jumbtron--> 
					<img src="img/doctorlogo.png" class="col-md-12 text-center" style="display: block; width: 35%; margin-right: auto; margin-left: auto;">
